...
--Q2: How to keep track of when a record was las modified?

-- A2: maybe use an after update trigger?

 https://stackoverflow.com/questions/9522982:t-sql-trigger-update
-- https://stackoverflow.com/questions/4574010/how-to-create-trigger-to-keep-track-of-last-change-data
